...
//	$server_id =$action_id;
	...
	if($action == "insert" ){
		$qry = "insert into tbl_obd_dnd_list (";	
		$values = "";	
	} elseif($action == "update") {
		$qry = "update tbl_obd_dnd_list set ";		
		...
		$qry = "DELETE FROM `tbl_obd_dnd_list` WHERE `user_id`='".$user_id."' AND `server_id`='".$server_id."' AND `time_stamp`='".$time_stamp."'";
	}
