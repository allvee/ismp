 ...
 */
// // SGW \\ \\ 
$path_of_sgw_configuration = "/var/www/html/ismp/test_file_dir/SGW/config.ini";
$path_of_sgw_channel_map = "/var/www/html/ismp/test_file_dir/SGW/channelmap.ini";
...
$single_sms_url = "http://".$_SERVER['HTTP_HOST']."/SendSMS/SendSingleSMS.php?";
$bulk_sms_url = "http://".$_SERVER['HTTP_HOST']."/SendSMS/SendMultipleSMS.php?";
$cde_url = "http://".$_SERVER['HTTP_HOST']."/CDE/cde.php?";

// // CMS \\ \\
$path_of_cms_direct_sms_url = "http://".$_SERVER['HTTP_HOST']."/ContentManagement/generatecontent.php?category=";
...
// // Customer Support \\ \\
$single_service_status_url= "http://10.183.188.120/SingleServiceAPI/SingleServiceStatus.php";
$call_details_url= "http://10.183.188.120/CallDetails/CallDetails.php?msisdn=";
$sms_details_url="http://".$_SERVER['HTTP_HOST']."/CallDetails/SmsDetails.php?msisdn=";
// http://10.183.188.120/SubscriptionServiceStatus/ServiceStatus.php?msisdn=
// // Content Send URL \\ \\ 
$PATH_OF_CONTENT_UPLOAD = "http://".$_SERVER['HTTP_HOST']."/ContentManagement/generatecontent.php?category=";

$CMS_REQUIRED_CONTENT_UPLOAD_PERMISSION = false;
?>