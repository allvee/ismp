...
<script type="application/javascript">
	$(document).ready(function() {
		...
		pagination("dnd_list",["obdServerInstance"],"report/view_dnd_list",null,null);
		
		$("#submit").click(function() {
			var value_arr = {};
			value_arr["obdServerInstance"] = "#obdServerInstance";
			file_upload(true,"modules/obd/fileImportDND","file",value_arr,["csv"],null,"dnd_list","report/view_dnd_list",null,null);
		});
...
<div class="subsection">
	...
	<div class="tblcss" id="view_dnd_list" style="height:300px; overflow:auto;">
	</div>
</div>
