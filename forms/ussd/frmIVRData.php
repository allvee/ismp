<h1>USSD : USSD Tree Data</h1>
	<div class="breadcrumb">
		<ul>
			<li><a href="#">USSD</a></li>
			<li><a href="#">USSD Tree Data</a></li>
        </ul>
	</div>
	<div class="content">
      <div class="halfpan fl">
         <h2>USSD Tree Data</h2>
...
<script>
	...
	{
			var service_list = restore_fields("modules/ussd/ussd_get_service_and_page",null);
	...
	$(document).ready(function(){
		...
		$("#submit").click(function() { 
			...
			pagination("ivr_data",["UniqueID","RateName","ServiceID","PackageID","ChargingType","CallTypeID","TimeSlotID","SubscriptionGroupID","SubscriptionStatus","RateID"],"report/view_ussd_ivr_data",null,null,search_options,null);
