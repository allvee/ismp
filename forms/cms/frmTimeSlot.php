<script type="application/javascript">
	$(document).ready(function() {
		...
		pagination("cms_timeSlot",["TimeSlotID","StartDay","EndDay","StartTime","EndTime"],"report/view_page",null,null);
    ...
    <div class="tblcss" id="view_cms_timeSlot" style="height:300px; overflow:auto;"></div>