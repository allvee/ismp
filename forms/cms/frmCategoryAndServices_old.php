...
<div class="content">
    ...
    <div class="halfpan fl">
        ...
        <label>Prompt</label>
        <input name="prompt" type="text" value="" id="prompt" />
        <label>Post Prompt </label>
        <input name="post_prompt" type="text" value="" id="post_prompt" />
    ...
    <div class="halfpan fr">
        ...
        <input name="pre_prompt" type="text" value="" id="pre_prompt" />
        <label>IVR-string </label>
        <input name="ivr_string" type="text" value="" id="ivr_string" />
        <label>Status </label>
